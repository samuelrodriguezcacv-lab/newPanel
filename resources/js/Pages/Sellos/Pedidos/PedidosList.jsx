...
import { obtenerOpcionesHojasPedido } from "../../../Utils/generarPdfPedido.js";
import { useFeedbackModal } from "../../../Hooks/useFeedbackModal.jsx";
import { usePedidosList } from "../../../Hooks/usePedidosList.jsx";
...
export default function PedidosList() {
    ...
    const {
        ...
        pedidosFiltrados,
    } = usePedidosList({ notify, confirm });

    return (
        <Layout title="Gestion de Pedidos" subtitle="Visualiza, filtra y administra tareas y sellos por pedido">
            {feedbackModal}
            <div className="p-6 max-w-5xl mx-auto space-y-6">
                <div className="flex justify-end"><span className="self-start sm:self-center text-xs font-semibold bg-blue-50 text-blue-700 px-3 py-1.5 rounded-lg border border-blue-100">
